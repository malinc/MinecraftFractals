...
menger(2)
menger(2, '1')
creates a Menger sponge of depth 2 using default material, or using the
material '1'=Stone
...
Drone.extend('makeSponge', function(depth, material) {
	...
	if (depth == 0 ) {
		...
		return this.down(step).back(2*step);
	}
});
